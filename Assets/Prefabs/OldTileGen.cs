...
public class OldTileGen : MonoBehaviour
{
    ...
    [SerializeField]
    private TerrainTypeOld[] terrainTypes;
    ...
    private Color chooseTerrainType(float heightValue){
        foreach(TerrainTypeOld terrainObject in this.terrainTypes){
